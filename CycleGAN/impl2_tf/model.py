...
class CycleGAN:
    ...
    def __init__(self,X_train_file='',Y_train_file='',batch_size=1,image_size=256,
               use_lsgan=True,norm='instance',lambda1=10,lambda2=10,learning_rate=2e-4,
               beta1=0.5,ngf=64):
    ...
    def model(self):
        ...
        cycle_loss = self.cycle_consistency_loss(self.G, self.F, x, y)#应该是重构误差
    ...
    def discriminator_loss(self, D, y, fake_y, use_lsgan=True):
        ...
        Returns:
          loss: scalar
        """
        if use_lsgan:#lsgan的第二种损失函数，对于D，将real->1,fake->0.对于G，将fake->1
