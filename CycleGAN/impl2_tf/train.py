...
from GAN.CycleGAN.impl2_tf.model import CycleGAN
from datetime import datetime
import os
import logging
from GAN.CycleGAN.impl2_tf.utils import ImagePool
...
tf.flags.DEFINE_string('X', '../impl1_keras/datasets/tfrecords/apple.tfrecords',
                       'X tfrecords file for training, default: data/tfrecords/apple.tfrecords')
tf.flags.DEFINE_string('Y', '../impl1_keras/datasets/tfrecords/orange.tfrecords',
