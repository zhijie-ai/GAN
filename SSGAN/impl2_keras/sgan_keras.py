...
class SGAN():
    def __init__(self):
        ...
        plot_model(self.discriminator, to_file='png/discriminator_model.png', show_shapes=True)
        ...
        plot_model(self.generator, to_file='png/generator_model.png', show_shapes=True)
        ...
        plot_model(self.combined, to_file='png/combined_model.png', show_shapes=True)
    ...
    def build_discriminator(self):
        ...
        return Model(img, [valid, label],name='discriminator')
    ...
    def train(self, epochs, batch_size=128, sample_interval=50):
        ...
        for epoch in range(epochs):
            ...
            print('==============',d_loss_real,self.discriminator.metrics_names)
